...
#        | desired state | action               |
#        | A @ $30/mo    | change (A @ $30/mo, B @ $40/mo) @ $70/mo to (A @ $30/mo) @ $30/mo now |
# 
#    Scenario Outline: Changing a current payment profile to a different product
#      Given I support Single Payment Strategy
#      And   Today is 3/10/12
#      And   I have the following subscriptions:
#      # | billing profile       | status    | #comments                                                | next billing date   |
...
#        | desired state | action               |
#        | B @ $20/mo    | change (A @ $30/mo) @ $30/mo to (B @ $30/mo) @ $30/mo now |
# 
...
#        | desired state | action               |
#        | B @ $40/mo    | cancel (A @ $30/mo) @ $30/mo now, add (B @ $40/mo) @ $40/mo on 4/10/12 with initial payment set to $20 |
# 
...
#        | desired state | action               |
#        | A @ $300/yr    | cancel (A @ $30/mo) @ $30/mo now, add (A @ $300/yr) @ $300/yr on 3/10/13 with initial payment set to $280 |
# 
...
#        | desired state | action               |
#        | A @ $30/mo    | cancel (A @ $300/yr) @ $300/yr now, add (A @ $30/mo) @ $30/mo on 4/1/12 |
# 
...
#               create a new one crediting the customer for amount paid but unused
#        | desired state | action               |
#        | B @ $300/yr    | cancel (A @ $30/mo) @ $30/mo now, add (B @ $300/yr) @ $300/yr now |
# 
...
#               schedule the new one starting at the end to the current payment profile
#        | desired state | action               |
#        | B @ $30/mo    | cancel (A @ $300/yr) @ $300/yr now, add (B @ $30/mo) @ $30/mo now |
# 
# 
# 
# 
